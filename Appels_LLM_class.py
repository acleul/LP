...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    prompt: str #Question de l'utilisateur
        ...
        "Ophtalmologie": ["Cataracte", "Chirurgie de la cornée", "Rétine", "Glaucome", "Strabisme"],
        "Gynécologie et cancers de la femme": ["Cancer de l'ovaire", "Cancer de l'utérus", "Cancer du sein", "Endométriose", "Fibrome utérin"],
        "Appareil digestif": ["Appendicite", "Cancer de l'estomac et de l'œsophage", "Cancer du colon ou de l'intestin", "Cancer du foie", "Cancer du pancréas", "Chirurgie de l'obésité", "Chirurgie du rectum", "Hernies de l'abdomen", "Maladies inflammatoires chroniques de l'intestin (MICI)", "Proctologie"],
