                    ...
                    if selected_option is not None:
                        with st.spinner('Chargement'):
                            ...
                            try:
                                ...
                                st.warning(f"En raison de problèmes d'API:{e}, le service d'assistance au palmarès des hôpitaux est momentanément indisponible, merci de réessayer dans quelques instants.")
                                st.stop()
